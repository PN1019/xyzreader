        ...
        public void onReceive(Context context, Intent intent) {
            if (UpdaterService.BROADCAST_ACTION_STATE_CHANGE.equals(intent.getAction())) {
                if (intent.hasExtra(UpdaterService.EXTRA_ERROR)){
                    ...
                    Snackbar.make(mSwipeRefreshLayout,resources.getString(R.string.error_connection),Snackbar.LENGTH_LONG)
                            .setAction(resources.getString(R.string.action_retry_connection),new View.OnClickListener() {
                                @Override
                ...
                public void onClick(View view) {
                    ...
                    if (vh.thumbnailView.getDrawable()!=null){
                        ...
                        Snackbar snackbar = Snackbar.make(mSwipeRefreshLayout,
                                resources.getString(R.string.error_data_availability),
